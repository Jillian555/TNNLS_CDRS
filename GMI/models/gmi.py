...
class GMI(nn.Module):
    ...
    def forward(self, seq1, adj_ori, neg_num, adj, samp_bias1, samp_bias2):
        ...
        return res_mi_pos, res_mi_neg, res_local_pos, res_local_neg, adj_rebuilt, h_2, h_semi
